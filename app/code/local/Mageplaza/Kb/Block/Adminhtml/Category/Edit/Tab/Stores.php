 ...
 * @author
 */
class Mageplaza_Kb_Block_Adminhtml_Category_Edit_Tab_Stores extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare the form
     *
     * @access protected
     * @return Mageplaza_Kb_Block_Adminhtml_Category_Edit_Tab_Stores
     * @author
     */
