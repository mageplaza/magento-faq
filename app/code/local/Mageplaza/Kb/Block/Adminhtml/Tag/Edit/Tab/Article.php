 ...
 */
/**
 * tag - article relation edit block
 *
 * @category    Mageplaza
 * @package     Mageplaza_Kb
 * @author
 */
class Mageplaza_Kb_Block_Adminhtml_Tag_Edit_Tab_Article extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
     ...
     *
     * @access protected
     * @return Mageplaza_Kb_Block_Adminhtml_Tag_Edit_Tab_Article
     * @author
     */
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            array('related' => $collection->getTable('mageplaza_kb/tag_article')),
    ...
    {
        $articles = array();
        $selected = Mage::registry('current_tag')->getSelectedArticles();
