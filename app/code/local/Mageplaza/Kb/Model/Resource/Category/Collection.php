 ...
 * @author
 */
class Mageplaza_Kb_Model_Resource_Category_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('mageplaza_kb/category_store')),
    ...
    protected function _toOptionArray($valueField='entity_id', $labelField='name', $additional=array())
    {
        ...
        foreach ($this as $item) {
            if ($item->getId() == Mage::helper('mageplaza_kb/category')->getRootCategoryId()) {
                continue;
            }
    ...
    public function addArticleFilter($article)
    {
        ...
        if (!isset($this->_joinedFields['article'])) {
            $this->getSelect()->join(
                array('related_article' => $this->getTable('mageplaza_kb/category_article')),
                'related_article.category_id = main_table.entity_id',
                array('position')
            );
