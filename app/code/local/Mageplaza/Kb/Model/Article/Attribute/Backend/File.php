 ...
 * @author
 */
class Mageplaza_Kb_Model_Article_Attribute_Backend_File extends Mage_Eav_Model_Entity_Attribute_Backend_Abstract
{
    ...
    public function afterSave($object)
    {
        ...
        $path = Mage::helper('mageplaza_kb/article')->getFileBaseDir();
