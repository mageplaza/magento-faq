 ...
 * @author
 */
class Mageplaza_Kb_Model_Resource_Article_Category_Collection extends Mageplaza_Kb_Model_Resource_Category_Collection
{
    /**
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->join(
                array('related' => $this->getTable('mageplaza_kb/article_category')),
