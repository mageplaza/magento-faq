 ...
 * @author
 */
abstract class Mageplaza_Kb_Helper_Image_Abstract extends Mage_Core_Helper_Data
{
    /**
     ...
     * @return Mageplaza_Kb_Helper_Image_Abstract
     * @author
     */
     ...
     * @access public
     * @param bool $value
     * @return mixed(bool|Mageplaza_Kb_Helper_Image_Abstract)
     * @author
     */
